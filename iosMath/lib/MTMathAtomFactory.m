...
+ (NSMutableDictionary<NSString*, MTMathAtom*>*) supportedLatexSymbols
{
    ...
    dispatch_once(&onceToken, ^{
        commands = [NSMutableDictionary dictionaryWithDictionary:@{
                     ...
                     // Extended coverage (basecompute local-patches):
                     ...
                     @"thorn" : [MTMathAtom atomWithType:kMTMathAtomOrdinary value:@"\u00FE"],
                     ...
                     @"bigcirc" : [MTMathAtom atomWithType:kMTMathAtomOrdinary value:@"\u25EF"],
                     ...
                     @"S" : [MTMathAtom atomWithType:kMTMathAtomOrdinary value:@"\u00A7"],
                     @"P" : [MTMathAtom atomWithType:kMTMathAtomOrdinary value:@"\u00B6"],
                     @"dag" : [MTMathAtom atomWithType:kMTMathAtomOrdinary value:@"\u2020"],
                     @"ddag" : [MTMathAtom atomWithType:kMTMathAtomOrdinary value:@"\u2021"],
                     @"copyright" : [MTMathAtom atomWithType:kMTMathAtomOrdinary value:@"\u00A9"],
                     @"pounds" : [MTMathAtom atomWithType:kMTMathAtomOrdinary value:@"\u00A3"],
                     @"ulcorner" : [MTMathAtom atomWithType:kMTMathAtomOrdinary value:@"\u231C"],
                     @"urcorner" : [MTMathAtom atomWithType:kMTMathAtomOrdinary value:@"\u231D"],
                     @"llcorner" : [MTMathAtom atomWithType:kMTMathAtomOrdinary value:@"\u231E"],
                     @"lrcorner" : [MTMathAtom atomWithType:kMTMathAtomOrdinary value:@"\u231F"],
                     @"diagup" : [MTMathAtom atomWithType:kMTMathAtomOrdinary value:@"\u2571"],
                     @"diagdown" : [MTMathAtom atomWithType:kMTMathAtomOrdinary value:@"\u2572"],
                     @"udots" : [MTMathAtom atomWithType:kMTMathAtomOrdinary value:@"\u22F0"],
                     @"textregistered" : [MTMathAtom atomWithType:kMTMathAtomOrdinary value:@"\u00AE"],
                     @"texttrademark" : [MTMathAtom atomWithType:kMTMathAtomOrdinary value:@"\u2122"],
                     @"textvisiblespace" : [MTMathAtom atomWithType:kMTMathAtomOrdinary value:@"\u2423"],
